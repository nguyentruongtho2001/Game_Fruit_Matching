...
mongoose.connect(
  "mongodb+srv://admin-prem:Godthegreat%401@cluster0.mxpup.mongodb.net/leaderboard"
);
//localhost:27017/LeadBoard
mongodb: var conn = mongoose.connection;
...
app.get("/leaderboard", function (req, res) {
  leaderBoard
    .find({ userMode: 4 }, function (err, element) {
...
app.get("/mediumleaderboard", function (req, res) {
  leaderBoard
    .find({ userMode: 5 }, function (err, element) {
...
app.get("/hardleaderboard", function (req, res) {
  leaderBoard
    .find({ userMode: 6 }, function (err, element) {
